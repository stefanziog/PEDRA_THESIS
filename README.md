...
IMPORTANT THINGS FOR A SMOOTH RUN:
1. Python Version 3.6 for the venv
2. AirSim version 1.2.2. This is important if you want to create environments that are compatible with PEDRA.
